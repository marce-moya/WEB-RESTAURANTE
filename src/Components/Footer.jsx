...
//           <Col md={6}>
//           <h6>Información de contacto</h6>
//             <p style={{ textAlign: 'justify' }}>Dirección: Calle Principal #123</p>
//             <p style={{ textAlign: 'justify' }}>Teléfono: 555-1234-5678</p>
//             <p style={{ textAlign: 'justify' }}>Email: empanadasdelacasa@gmail.com</p>
//             <div style={{ display: 'flex', gap: '10px', marginTop: '10px' }}>
//               <a href="https://www.facebook.com/home.php" target="_blank" rel="noopener noreferrer"><FaFacebook /></a>
//               <a href="https://twitter.com/home" target="_blank" rel="noopener noreferrer"><FaTwitter /></a>
//               <a href="https://www.instagram.com/?hl=es-es" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
//             </div>
//           </Col>
//           <Col md={6}>
//             <h6>Enlaces útiles</h6>
